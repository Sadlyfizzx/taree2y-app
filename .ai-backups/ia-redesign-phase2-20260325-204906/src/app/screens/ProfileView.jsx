  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        ...
        <div className="rounded-[28px] border border-slate-200 bg-white p-5 text-right shadow-sm dark:border-slate-800 dark:bg-slate-900">
          ...
          <h3 className="mt-4 text-lg font-black text-slate-900 dark:text-white">لغة التطبيق الحالية</h3>
          <p className="mt-2 text-sm font-bold text-slate-500 dark:text-slate-400">العربية المصرية · واجهة RTL كاملة. بما إن تغيير اللغة غير متاح حالياً، المعروض هنا معلومة واضحة وليس زرًا وهميًا.</p>
        </div>
      </div>
