...
const HELP_TOPICS = [
  ...
  },
  {
    ...
    text: 'لو الكود صالح، الخصم هيتطبق قبل التأكيد النهائي على نفس شاشة الدفع.',
  },
  {
    icon: Wallet,
    title: 'المحفظة والاسترداد',
    text: 'أي شحن أو استرداد أو خصم هتلاقيه ظاهر في المحفظة وحركة الحساب بوضوح.',
  },
  {
    icon: BookOpen,
    title: 'أول مرة تستخدم طريقي؟',
    text: 'افتح دليل الاستخدام من الرئيسية أو الحساب عشان تشوف الخطوات بشكل سريع ومرتب.',
  },
];
...
export default function ChatbotModal({ closeModal, user }) {
  return (
    <ModalShell
      onClose={closeModal}
      title="مركز المساعدة"
      subtitle={`أهلاً يا ${user?.name?.split(' ')[0] || 'صديق طريقي'}، هنا هتلاقي أهم الإجابات بشكل مباشر.`}
    ...
    >
      <div className="space-y-5">
        <div className="flex flex-wrap gap-2">
          ...
          <MetaChip label="خطوات حقيقية" tone="success" />
