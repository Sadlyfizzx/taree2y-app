...
function ProfileView({
  ...
  const deleteAccount = async () => {
    ...
    try {
      ...
      showToast('تم إرسال طلب حذف الحساب.', 'success');
    } catch (error) {
  ...
  return (
    <div className="space-y-5">
      <PageHeading
        eyebrow="الحساب"
        title="إعدادات الحساب فقط"
        subtitle="الملف الشخصي، كلمة المرور، المساعدة، والمظهر. المزايا الأخرى أصبحت في صفحاتها الخاصة."
      />
