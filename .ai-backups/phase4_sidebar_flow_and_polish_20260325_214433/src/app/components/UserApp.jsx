...
export default function UserApp({
  ...
  return (
    <>
      ...
      <aside
        className={`hidden h-full flex-col border-l border-slate-200 bg-[linear-gradient(180deg,rgba(255,255,255,0.92)_0%,rgba(248,250,252,0.88)_100%)] px-4 py-5 backdrop-blur dark:border-slate-800 dark:bg-[linear-gradient(180deg,rgba(2,6,23,0.96)_0%,rgba(15,23,42,0.92)_100%)] md:flex ${
          isSidebarOpen ? 'w-[318px]' : 'w-[108px]'
        }`}
      >
        ...
        <nav className="mt-6 flex-1 space-y-3">
          <div className="space-y-2">
            <p className={`px-3 text-[11px] font-black uppercase tracking-[0.16em] text-slate-400 dark:text-slate-500 ${isSidebarOpen ? '' : 'text-center'}`}>الأساسي</p>
        ...
        {isSidebarOpen ? (
          <div className="mt-8 space-y-3 rounded-[30px] border border-slate-200 bg-white/92 p-4 shadow-[0_18px_40px_-28px_rgba(16,35,63,0.22)] dark:border-slate-800 dark:bg-slate-900/92">
            <p className="text-sm font-black text-slate-900 dark:text-white">مختصر اليوم</p>
