...
export default function App() {
  ...
  return (
    <div
      className={`min-h-[100svh] w-full overflow-x-clip transition-colors duration-300 md:min-h-[100dvh] ${isDark ? 'dark bg-[var(--bg)] text-[var(--ink)]' : 'bg-[var(--bg)] text-[var(--ink)]'}`}
      dir="rtl"
    >
