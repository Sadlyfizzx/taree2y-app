...
export function DesktopNavItem({ icon, label, active, onClick, collapsed }) {
  return (
    <button
      ...
      className={cx(
        'group flex w-full items-center rounded-[24px] border px-4 py-3.5 text-right transition-all duration-200',
        collapsed ? 'justify-center px-3' : 'gap-3',
        active
          ? 'border-transparent bg-[linear-gradient(135deg,rgba(33,86,217,0.12)_0%,rgba(15,159,138,0.08)_100%)] text-indigo-700 shadow-[0_16px_34px_-24px_rgba(16,35,63,0.45)] dark:bg-[linear-gradient(135deg,rgba(33,86,217,0.22)_0%,rgba(15,159,138,0.12)_100%)] dark:text-indigo-200'
    ...
    >
      <span className={cx(
        ...
        active
          ? 'bg-white/85 text-current shadow-sm dark:bg-slate-900/85'
