          ...
          <div className="mt-4 space-y-2.5 sm:mt-5 sm:space-y-3">
            {displayedTransactions.map((transaction) => {
              ...
              return (
                <div
                  key={transaction.id}
                  className="rounded-[20px] border border-slate-200 bg-slate-50 px-3 py-3 dark:border-slate-800 dark:bg-slate-950/60 sm:rounded-[24px] sm:px-4 sm:py-4"
                >
                  <div className="flex items-start justify-between gap-3 sm:hidden">
                    <div className="flex min-w-0 items-start gap-3">
                      <span
                        className={`grid h-10 w-10 shrink-0 place-items-center rounded-[18px] ${
                          isCredit
                            ? 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/20 dark:text-emerald-300'
                            : 'bg-indigo-50 text-indigo-700 dark:bg-indigo-900/20 dark:text-indigo-300'
                        }`}
                      >
                        {isCredit ? <ArrowDown className="h-4.5 w-4.5" /> : <Ticket className="h-4.5 w-4.5" />}
                      </span>
                    ...
                    <div className="shrink-0 rounded-2xl border border-slate-200 bg-white px-3 py-2 text-left dark:border-slate-800 dark:bg-slate-900">
                      <p
                      ...
                      <p className="mt-0.5 text-[10px] font-black text-slate-400 dark:text-slate-500">
                        {isCredit ? 'إضافة' : 'خصم'}
                      </p>
                    </div>
                  </div>
