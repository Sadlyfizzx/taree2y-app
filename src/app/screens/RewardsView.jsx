...
import { Award, Copy, Crown, Gift, Sparkles } from 'lucide-react';
...
export default function RewardsView({
  ...
  return (
    <div className="space-y-5">
      <PageHeading
        eyebrow="المكافآت"
        title="النقاط والدعوات والعروض"
        subtitle="كل قيمة إضافية في مكان واحد، من غير كروت مكررة أو شرح زائد."
      />

      <AppSurface className="overflow-hidden p-5 sm:p-6">
        <div className="grid gap-5 xl:grid-cols-[1.1fr_0.9fr] xl:items-start">
          <section className="relative overflow-hidden rounded-[30px] bg-[linear-gradient(135deg,#10233f_0%,#163c98_48%,#2156d9_100%)] p-5 text-white">
            ...
            <div className="relative z-10">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <p className="mt-2 text-sm font-bold text-white/80">
                    {isGold ? 'وصلت للمستوى الذهبي.' : `فاضلك ${Math.max(0, 1000 - pointsValue)} نقطة للوصول للمستوى الذهبي.`}
                  </p>
                </div>
              ...
              <div className="mt-5 grid gap-3 sm:grid-cols-3">
                <div className="rounded-[20px] border border-white/12 bg-white/10 p-4">
                  <p className="text-sm font-black">استبدال النقاط</p>
                  <p className="mt-2 text-sm font-bold text-white/80">كل 500 نقطة تقدر تتحول لرصيد في المحفظة.</p>
                </div>
                <div className="rounded-[20px] border border-white/12 bg-white/10 p-4">
                  <p className="text-sm font-black">الدعوات</p>
                  <p className="mt-2 text-sm font-bold text-white/80">شارك كودك أو استخدم كود دعوة قبل أول حجز ناجح.</p>
                </div>
                <div className="rounded-[20px] border border-white/12 bg-white/10 p-4">
                  <p className="text-sm font-black">العروض</p>
                  <p className="mt-2 text-sm font-bold text-white/80">لو عندك عرض مناسب، هتلاقيه هنا مباشرة.</p>
                </div>
              </div>
          ...
          <div className="space-y-4">
            <InlineNotice tone="info" title="الفكرة ببساطة" text="الصفحة دي لثلاث حاجات فقط: نقاطك، الدعوات، والعروض المخصصة ليك. من غير تكرار أو زحمة." />
            {promoHighlights.length > 0 ? (
              <AppSurface className="p-5">
                <SectionHeader title="عرض نشط الآن" subtitle="لو فيه عرض مخصص ليك، هتلاقيه هنا فورًا." />
                <div className="mt-4 grid gap-4">
                  {promoHighlights.slice(0, 1).map((offer) => (
              ...
              <InlineNotice tone="neutral" title="لا يوجد عرض مخصص الآن" text="أول ما يبقى عندك عرض مناسب، هيظهر هنا تلقائيًا من غير ما نملأ الصفحة بعنصر فارغ." />
            )}
          </div>
        </div>
      </AppSurface>
